...
let CONFIG = {
  ...
  urlsToCache: [
    ...
    '/index.html',
    '/manifest.json',
    '/icons/Proweaverlogo/favicon.ico',
    '/icons/Proweaverlogo/main-logo2.svg',
    '/icons/Proweaverlogo/apple-touch-icon.png',
    '/icons/Proweaverlogo/favicon-96x96.png',
    '/icons/Proweaverlogo/android-chrome-192x192.png',
    '/icons/Proweaverlogo/android-chrome-512x512.png'
  ],
